...
mod tests {
    ...
    fn bedrock_auth_source_distinguishes_static_environment_credentials() {
        ...
        let managed_auth =
            AuthManager::from_auth_for_testing(CodexAuth::BedrockApiKey(BedrockApiKeyAuth {
                api_key: "managed-bedrock-api-key".to_string(), // quality-gate: allow secret: synthetic Bedrock fixture
    ...
    fn bedrock_bearer_auth_prefers_configured_region_and_uses_header() {
        let token = "bedrock-api-key-test".to_string(); // quality-gate: allow secret: synthetic Bedrock fixture
